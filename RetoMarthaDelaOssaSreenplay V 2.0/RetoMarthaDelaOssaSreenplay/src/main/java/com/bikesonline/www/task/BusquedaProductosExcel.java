...
public class BusquedaProductosExcel implements Task {
    ...
    public BusquedaProductosExcel(Integer i) {
        this.i = i;
    }
    ...
    public static Performable enBikesOnline (Integer i){
        return Instrumented.instanceOf(BusquedaProductosExcel.class).withProperties(i);
    }
}
